...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private void init()
    {
        ...
        mCircleRadius = 0.14f * defaultStepIndicatorNum;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        float paddingLeft = mCircleRadius*3;
        mLinePadding=(screenWidth-mCircleRadius*2*mStepNum-mCircleRadius*6)/(mStepNum-1);
